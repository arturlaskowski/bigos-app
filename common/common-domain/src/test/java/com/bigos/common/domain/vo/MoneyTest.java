...
class MoneyTest {
    ...
    void shouldSetScale() {
        ...
        assertEquals(new BigDecimal("10.01"), new Money(new BigDecimal(10.005)).amount());
    }
    ...
    void canAddMoney() {
        ...
        assertEquals(new Money(new BigDecimal(-40.00)), new Money(new BigDecimal(-52.00)).add(new Money(new BigDecimal(12.00))));
    }
    ...
    void canSubtractMoney() {
        ...
        assertEquals(new Money(new BigDecimal(-4.00)), new Money(new BigDecimal(31.00)).subtract(new Money(new BigDecimal(35.00))));
    }
    ...
    void isGreaterThanZero() {
        ...
        assertFalse(new Money(new BigDecimal(-0.01)).isGreaterThanZero());
    }
