...
import com.bigos.order.entities.outbox.OrderOutboxEntity;
import com.bigos.order.entities.outbox.OrderOutboxEntityMapper;
...
@Repository
public class SqlOrderOutboxRepository implements OrderOutboxRepository {

    private final OrderOutboxRepositoryJpa outboxRepositoryJpa;
    private final OrderOutboxEntityMapper mapper;

    public SqlOrderOutboxRepository(OrderOutboxRepositoryJpa outboxRepositoryJpa, OrderOutboxEntityMapper mapper) {
